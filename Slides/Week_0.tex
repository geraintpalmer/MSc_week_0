...
\frame{
  \frametitle{Algebra}
	\begin{block}{}
	  {\large{\textit{``Algebra is the branch of mathematics concerning the
	  study of the rules of operations and relations, and the constructions and
	  concepts arising from them, including terms, polynomials, equations and
...
\frame{
  \frametitle{Solution}
  General form of line $y = mx + c$ through $\{(x_1, y_1),(x_2, y_2)\}$ can be
  obtained:
  $$\left.
    \begin{array}{@{}r@{\;}c@{\;}l@{}}
      y_1 & = & mx_1 + c\\
...
\frame{
  ...
  $$y = mx + c$$ are solved by muliplying or adding various constants.
...
\frame{
  ...
  \begin{align*}
    x = {{3 \over 2} \pm \sqrt{\left({3 \over 2}\right)^2 - 4 \times 3 \times(-2)} \over 2 \times 3}
      &\Leftrightarrow
    x = {{3 \over 2} \pm \sqrt{{9 \over 4} + 24} \over 6}\\[5mm]
...
\frame{
  ...
  \begin{align*}
    x = {2 \pm \sqrt{2^2 - 4 \times 4 \times 7} \over 2 \times 4}
      &\Leftrightarrow
    x = {2 \pm \sqrt{-108} \over 8}\\[5mm]
    x = {2 \pm \sqrt{i^2108} \over 8}
      &\Leftrightarrow
    x = {2 \pm i\sqrt{3 \times 36} \over 8}\\[5mm]
...
\frame{
  \frametitle{Calculus}
	\begin{block}{}
	  {\large{\textit{``Calculus is the study of change, in the same way that
...
\frame{
  ...
  $${d \over dx}f(x)={d \over dx}x^{1 \over 2}={1 \over 2}x^{{1 \over 2} - 1} = {1 \over 2\sqrt{x}}$$
  and
  $${d \over dx}g(x) = 2x$$
...
\frame{
  \frametitle{Calculus}
	\begin{block}{}
	  {\large{\textit{``Probability theory is the branch of mathematics
