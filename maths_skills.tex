...
\frame{
  ...
  \vspace{10mm}
  \begin{center}
    \includegraphics[width=0.49\textwidth]{img/increasing.pdf}
    \includegraphics[width=0.49\textwidth]{img/decreasing.pdf}
  \end{center}
}
...
\frame{
  ...
  5 - 2x - 5 &\geq 13 - 5\\
  -2x &\geq 8\\
  -2x \times {1 \over -2} &\leq 8 \times {1 \over -2} \quad \text{\color{black}{apply decreasing $f$}}\\
  x &\leq -4
  \end{align*}
}
...
\frame{
  ...
  \begin{center}
    $(1.3, 0.75)$\\
    \includegraphics[width=7cm]{img/coordinate_system}\\
  \end{center}
...
\frame{
  ...
  equation.
  \begin{center}
    \includegraphics[width=7cm]{img/xcubed}
  \end{center}
  \begin{center}
  $y = x^3$
  \end{center}
...
\frame{
  ...
  \begin{center}
    \includegraphics[width=7cm]{img/2points}
  \end{center}
}
...
\frame{
  ...
  \end{array}$$
  \begin{center}
    \includegraphics[width=7cm]{img/2pointsandline}
  \end{center}
}
...
\frame{
  ...
  \begin{center}
    \includegraphics[width=7cm]{img/quadratic}
  \end{center}
}
...
\frame{
  ...
  \only<1>{
    \begin{center}
      \includegraphics[width=7cm]{img/inductionpic}
    \end{center}
  }
  \only<2>{
    \begin{center}
      \includegraphics[width=7cm]{img/inductionpic1}
    \end{center}
  }
}
...
\frame{
  ...
  \begin{center}
    \includegraphics[width=7cm]{img/domain_range}
  \end{center}
  \pause
  \begin{itemize}
...
\frame{
  ...
  \end{center}
  \begin{center}
    \includegraphics[width=7cm]{img/function}
  \end{center}
}
...
\frame{
  ...
  \only<1>{
    \begin{center}
      \includegraphics[width=7cm]{img/tangent_line}
    \end{center}
  }
  \only<2>{
    \begin{center}
      \includegraphics[width=7cm]{img/tangent_line_1}
    \end{center}
  }
  \only<3>{
    \begin{center}
      \includegraphics[width=7cm]{img/tangent_line_2}
    \end{center}
  }
  \only<4>{
    \begin{center}
      \includegraphics[width=7cm]{img/tangent_line_3}
    \end{center}
  }
  \only<5>{
    \begin{center}
      \includegraphics[width=7cm]{img/tangent_line_4}
    \end{center}
  }
}
...
\frame{
  ...
  $${d \over dx}e^x = e^x$$
  \begin{center}
    \includegraphics[width=7cm]{img/exp}
  \end{center}
}
...
\frame{
  ...
  A standard procedure used when analysing data is to transform with $\log$.
  Here we compare populations and areas of the countries of the world:
  \begin{center}
    \includegraphics[width=5.2cm]{img/beforelog}
    \pause
    \includegraphics[width=5.2cm]{img/afterlog}
  \end{center}
}
...
\frame{
  ...
  \begin{center}
    \includegraphics[width=7cm]{img/area_under_graph_0.pdf}
  \end{center}
}
...
\frame{
  \frametitle{Area under a graph}
  \begin{center}
    \includegraphics[width=7cm]{img/area_under_graph_1.pdf}
  \end{center}
}
...
\frame{
  \frametitle{Area under a graph}
  \begin{center}
    \includegraphics[width=7cm]{img/area_under_graph_2.pdf}
  \end{center}
}
...
\frame{
  \frametitle{Area under a graph}
  \begin{center}
    \includegraphics[width=7cm]{img/area_under_graph_3.pdf}
  \end{center}
}
...
\frame{
  \frametitle{Area under a graph}
  \begin{center}
    \includegraphics[width=7cm]{img/area_under_graph_4.pdf}
  \end{center}
}
...
\frame{
  ...
  Mean:
  \begin{align*}
    E(X) &= {1 \over 6} + {2 \over 6} + {3 \over 6} + {4 \over 6} + {5 \over 6} + {6 \over 6}\\
    &= 3.5
  \end{align*}
  Variance:
  \small{
  \begin{align*}
    Var(X) &= {(1 - 3.5)^2 \over 6} + {(2 - 3.5)^2 \over 6} + {(3 - 3.5)^2 \over 6}\\
...
\frame{
  ...
  \begin{itemize}
    \item \url{https://intranet.cardiff.ac.uk/students/your-study/study-skills/maths-support}
    \item \url{https://github.com/drvinceknight/MSc_week_0/wiki}
    \item \url{http://www.geraintianpalmer.org.uk/teaching/}
  \end{itemize}
}
